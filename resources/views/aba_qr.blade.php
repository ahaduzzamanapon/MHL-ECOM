                    ...
                    <div style="width: 200px;margin: 0 auto;display: none;">
                        <div class="wpr_payment_option">
                            <div style="margin-top: 10px">
                                <input type="radio" name="payment_option" class="payment_option"
                                    style="margin: 14px;float: left;" checked value="<?= $payment_option?>">
                                <label class="paymentOption" for="khqr">
                                    <img class="cardType" src="logos/ic_KHQR_x2.png">
                                    <span class="detailCard002"
                                        style="margin-left: 16px; float: right; position: absolute;">
                                        <strong><span class="titleCard">ABA KHQR</span><br /></strong>
                                        <span class="detailCard003" style="margin-top: 5px;">Scan to pay with any
                                            banking app</span>
                                    </span>
                                </label>
                            </div>
